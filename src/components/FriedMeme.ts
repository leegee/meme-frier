...
export class FriedMeme extends PolymerElement {
    ...
    static get properties() {
        return {
            ...
            totalJpegs: { type: Number, value: 2 },
            ...
            noise: { type: Number, value: 0.9 }, // 0-1
    ...
    private async _fry(currentDip = 1) {
        console.log('Enter _fry for dip ', currentDip);
